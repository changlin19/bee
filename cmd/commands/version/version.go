...
func GetBeegoVersion() string {
	...
	for _, wg := range wgopath {
		wg, _ = path.EvalSymlinks(path.Join(wg, "src", "github.com", "changlin19", "beego"))
	...
	return "Beego is not installed. Please do consider installing it first: https://github.com/changlin19/beego"
}
